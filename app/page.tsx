    ...
    <main className="home-page compact-home">
      <section className="home-hero compact-hero">
        <div className="home-hero-copy">
          ...
          <p>
            It reads the real system state, compares it with the agent&apos;s intent, and chooses the safe next step.
          </p>
      ...
      <section className="home-section example-section">
        <div className="section-heading">
          ...
          <p className="signal-line">A timeout does not necessarily mean the action failed.</p>
        </div>
        <div className="example-flow" aria-label="Timeout after write example">
          ...
          <FlowStep label="System of record" value="Reserve = $8,400" status="success" />
          <FlowStep label="Relay" value="Applied - Do not retry" status="success" />
        </div>
        <p className="closing-line">Relay checks reality before deciding what happens next.</p>
      </section>

      <section className="home-section rule-section">
        <div className="section-heading">
          <h2>The general rule</h2>
          <p>Relay bases recovery on authoritative evidence, not the API response alone.</p>
        </div>
        <div className="outcome-strip" aria-label="Relay recovery outcomes">
          <Outcome label="Effect exists" value="Complete" tone="success" />
          <Outcome label="Effect is absent" value="Retry safely" tone="warning" />
          <Outcome label="Truth cannot be proven" value="Stop / investigate" tone="manual" />
        </div>
      </section>
      ...
      <section className="home-section explore-section compact-explore">
        ...
        <div className="featured-scenarios compact-scenarios">
          <FeaturedScenario
            ...
            text="Write succeeds, response is lost."
          />
          <FeaturedScenario
          ...
          <FeaturedScenario
            ...
            text="Success or failure cannot be safely proven."
          />
        </div>
